...
- When the sibling `matlab-math-modeling` Skill is installed, invoke it for MATLAB execution preflight, toolbox-aware solver selection, reusable paper styling, export, and MATLAB result validation.
